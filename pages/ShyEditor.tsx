      ...
      <aside className={`transition-all duration-500 border-r border-white/5 bg-[#0a0a0a] flex flex-col ${isSidebarOpen ? 'w-96' : 'w-0 opacity-0 overflow-hidden'}`}>
        <div className="p-6 border-b border-white/5 space-y-4">
          <div className="flex justify-between items-center">
            <h3 className="text-accent text-[10px] font-bold uppercase tracking-[0.4em]">WRAPPER Partnership</h3>
        ...
        <div className="flex-grow overflow-y-auto p-6 space-y-6 custom-scrollbar">
          {messages.length === 0 && (
            <div className="h-full flex flex-col items-center justify-center opacity-30 text-center px-4">
              <p className="text-xs italic font-serif">"I am listening to your sheets in {region}. Ready to find your flow."</p>
            </div>
          )}
          {messages.map((m, i) => (
        ...
        <div className="flex-grow flex justify-center p-12 lg:p-24 overflow-y-auto custom-scrollbar">
          <div className="max-w-3xl w-full">
            ...
            <textarea 
              ...
              placeholder="Your truth starts here..."
            />
          </div>
        </div>
